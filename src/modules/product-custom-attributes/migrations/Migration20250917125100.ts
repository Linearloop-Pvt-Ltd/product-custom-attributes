...
export class Migration20250917125100 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table if not exists "product_custom_attribute" ("id" text not null, "product_id" text not null, "value" text not null, "is_visible" boolean not null default true, "category_custom_attribute_id" text not null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "product_custom_attribute_pkey" primary key ("id"));`);
